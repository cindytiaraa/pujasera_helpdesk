...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      final notifications = await NotificationService.getNotifications(SessionService.userId);
      if (mounted) {
        setState(() {
  ...
  Future<void> _markAllRead() async {
    try {
      await NotificationService.markAllAsRead(SessionService.userId);
      await _loadData();
      if (mounted) {
                      ...
                      return InkWell(
                        onTap: () async {
                          try {
                            ...
                            _loadData();
                            if (n.ticketId.isNotEmpty && mounted) {
                          ...
                          child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              Row(children: [
                                ...
                                Text(AppUtils.timeAgo(n.createdAt),
